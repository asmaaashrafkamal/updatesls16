...
<script src="https://cdnjs.cloudflare.com/ajax/libs/qs/6.7.0/qs.min.js"></script>
  ...
  <body>
      ...
      <?php
               if(!empty($m)){
                if($m=="fail"){
                  echo '<div style=""><div class="alert alert-danger"   role="alert"><h4 style="text-align:center;"> Das Passwort des Benutzers wurde nicht aktualisiert </h4> </div></div>';
                  }else{
        ...
        <section class="container reset-container">
          ...
          <fieldset>
            ...
            <div></div>
            <div>
              <input type="password"  name="pass1" id="pass1" placeholder="Neues Kennwort" onkeyup="checkPass();"/>
            </div>
        <div>
              <input type="password" name="pass2" id="pass2" placeholder="Kennwort bestätigen" onkeyup="checkPass();"/>
              <span id="confirm-message3" class="confirm-message"></span>
              <br>

            </div>
        <div>
            <button name="resetPassword">Bestätigen Sie</button>
        </div>
        </form>
