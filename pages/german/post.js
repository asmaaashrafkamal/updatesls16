    ...
    findUserByEmail1(function(arr) {
        ...
        for (let i = 0; i < arr.length; i++) {
            ...
            if(arr[i]['unseen']==true){
                tr += "<tr><td>" + arr[i]['reporterUser']['reporterName'] + "</td><td>" + arr[i]['postUser']['postUserName'] + "</td><td style='color:red;'>ungesehen</td><td><a  id='getid" + i + "' href=''>Verwandter Beitrag</a></td></tr>";
            }else{
            tr += "<tr><td>" + arr[i]['reporterUser']['reporterName'] + "</td><td>" + arr[i]['postUser']['postUserName'] + "</td><td style='color:green;'>gesehen</td><td><a  id='getid" + i + "' href=''>Verwandter Beitrag</a></td></tr>";
            }
