        ...
        .then((querySnapshot) => {
            querySnapshot.forEach((doc) => {
                if(doc.id==id){
                   ...
                   document.getElementById("email1").innerText="E-Mail-Addresse :-";    
                   ...
                   if(doc.data().phoneNumber !=""){   
                    document.getElementById("phone1").innerText="Telefonnummer :-" 
                   document.getElementById("phone").innerText="Phone Number :"+doc.data().phoneNumber
                   }if(doc.data().adress !=""){
                    document.getElementById("address1").innerText="Lieferanschrift :-";
                   document.getElementById("address").innerText=doc.data().adress;
                   }
                   if(doc.data().DOB !=""){
                    document.getElementById("birthdate1").innerText="Geburtsdatum :-";
                   ...
                   if(doc.data().paymentDetails.PayPalAccount !=""){
                    document.getElementById("details").innerText="Zahlungsdetails :-";
                    document.getElementById("PayPalAccount").innerText="PayPal Konto :"+doc.data().paymentDetails.PayPalAccount;
