                                    ...
                                    .then((querySnapshot) => {
                                        if (!querySnapshot.empty) {
                                           ...
                                           if(p1.length !=0){
                                            ...
                                            console.log(n)
                                            if(price*0.05==0){
                                            pay.push(arr[i]['profileImg'],arr[i]['userName'], arr[i]['email'],price*0.05,"Payed",doc.id)

                                           }else{
                                            notpay.push(arr[i]['profileImg'],arr[i]['userName'], arr[i]['email'],price*0.05,"Not Payed",doc.id)
                                        ...
                                        if (total1.length == 0) {
                                            tbody.innerHTML = "<h3 style='text-align:center;color:gold;'>No One Payed</h3>"
                                        } else {
                                            var tr=""
                                            for (let i = 0; i < total_all.length; i++) {
                                                if(total_all[i][4]=="Payed"){
                                        ...
                                        console.log(total)
                                        console.log(total1)
                                         document.getElementById("sell").innerHTML='<select class="custom-select" id="gender2"><option value=""  disabled selected hidden> Choose  </option><option value="all">All</option><option value="pay">Pay</option><option value="notpay">Not Pay</option></select>';
                                         document.getElementById("gender2").addEventListener("click",e=>{
                                            ...
                                            if (total.length == 0) {
                                                tbody.innerHTML = "<h3 style='text-align:center;color:gold;'>No Seller Found</h3>"
                                              ...
                                              const database = firebase.firestore();
                                               database.collection("Users").doc(doc.id).collection('Orders').get()
                                                   .then((querySnapshot) => {
                                                       ...
                                                       n.push(price)
                                                       if(price*0.05==0){
                                                           // document.getElementById("price"+i).innerHTML = (price*0.05).toFixed(2);
                                                           // document.getElementById("state"+i).innerText ="------------" ;
                 
                                                       }else{
                                                           // document.getElementById("price"+i).innerHTML ="<h4 style='color:red'>" +(price*0.05).toFixed(2)+"</h4>";
                                                           notpay.push(arr[i]['profileImg'],arr[i]['userName'], arr[i]['email'],price*0.05,"Not Payed",doc.id)
                                                           // document.getElementById("state"+i).innerText ="Not Payed " ;
                                                       ...
                                                       price=0;
                                                           ...
                                                           n.push(price)
                                                           // document.getElementById("price"+i).innerText = (price*0.05).toFixed(2);
                                                           // document.getElementById("state"+i).innerText ="Not Payed" ;
