...
function geturl(url){
    ...
    function test4(id,user) {
      document.getElementById("img1").innerHTML="<h3> Uploaded By:"+user+"</h3>"
         ...
         console.log(arr[i]['context']['video']) 
          if( arr[i]['context']['video']!=''){ 
            ...
            if(arr[i]['context']['text']!=""){
              document.getElementById("text").innerHTML="Title is :"+arr[i]['context']['text'] 
              }
              if(arr[i]['context']['productPrice']!=""){
                document.getElementById("text1").innerHTML="Price is :"+arr[i]['context']['productPrice']
                }
